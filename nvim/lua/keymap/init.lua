...
local plug_map = {
    ...
    ["n|gh"] = map_cr("lua vim.lsp.buf.references()"):with_noremap()
        :with_silent(),
    ["n|<Leader>tt"] = map_cu('lua require("FTerm").toggle()'):with_noremap()
        :with_silent(),
    ["t|<Leader>tt"] = map_cu([[<C-\><C-n><CMD>lua require("FTerm").toggle()]]):with_noremap()
        :with_silent(),
    ...
    ["n|<leader>cl"] = map_cr("TroubleToggle loclist"):with_noremap()
        :with_silent(),
    -- Plugin nvim-tree
    ["n|<Leader>ne"] = map_cr("NvimTreeToggle"):with_noremap():with_silent(),
    ...
    ["n|<Leader>lo"] = map_cr("SymbolsOutline"):with_noremap():with_silent(),
