...
local vim_path = require("init-global").vim_path
local data_dir = require("init-global").data_dir
...
function plugins.load_compile()
    ...
    vim.cmd [[command! PackerCompile lua require('init-pack').magic_compile()]]
    vim.cmd [[command! PackerInstall lua require('init-pack').install()]]
    vim.cmd [[command! PackerUpdate lua require('init-pack').update()]]
    vim.cmd [[command! PackerSync lua require('init-pack').sync()]]
    vim.cmd [[command! PackerClean lua require('init-pack').clean()]]
    vim.cmd [[autocmd User PackerComplete lua require('init-pack').magic_compile()]]
    vim.cmd [[command! PackerStatus lua require('init-pack').magic_compile() require('packer').status()]]
end
